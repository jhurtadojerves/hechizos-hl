...
from .views import (
    ...
    SpellRangeAPIList,
    CategoryAPIList,
    RangeCategoryAPIList,
    SpellRangeCategoryAPIList,
    SpellGroupAPIList,
)
...
urlpatterns = [
    ...
    url(regex="^categories/$", view=CategoryAPIList.as_view(), name="category-list"),
    url(
    ...
    url(regex="^spells/$", view=SpellAPIList.as_view(), name="list"),
    url(
        regex="^spells/(?P<slug>[-\w]+)/$", view=SpellAPIDetail.as_view(), name="detail"
    ),
    url(
